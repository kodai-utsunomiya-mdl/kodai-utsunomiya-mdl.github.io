...
- `public/js/admin.js` 管理画面のロジック
- `public/js/notes.js` Notes検索ロジック
...
frontmatterは `yaml` で生成/解析しているため，コロンや引用符の混在も許容される．
